  ...
  return (
    <Container
      ...
      <ScrollView
        ...
        {props.estimatedDeliveryTimeShown ? (
          <View style={styles.group}>
        ...
        <Button
          onPress={() => {
            ...
            unitOfMeasure && props.unitOfMeasureShown
              ? (body.unit_of_measure = unitOfMeasure)
              : null;
            money.getRawValue() > 0 && props.priceShown
              ? (body.price = money.getRawValue())
              : null;
            props.estimatedDeliveryTimeShown &&
              estimatedDeliveryTime !== '' &&
              (body.estimated_delivery_time = estimatedDeliveryTime);
            productPicture && props.photoShown
              ? (body.productPicture = productPicture)
              : null;
            availability && props.availabilityShown
